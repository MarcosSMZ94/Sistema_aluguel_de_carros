				...
				<div id="logo">
					...
					<div id="menu">
						<ul>
							...
							?>
							<li><a href="economicos.php"  title="">Econômicos</a></li>
							<li><a href="utilitarios.php"  title="">Utilitários</a></li>
							<li><a href="suv.php" title="">SUV</a></li>
							<li class="current_page_item"><a href="luxo.php"  title="">Luxo</a></li>
									...
									<div id='portfolio' class='container_carros'>
										<div class='column10'>
											<div class='boxcar'>
												...
												<h3><strong>Modelo  </strong>$marcaAutomovel</h3>							
												<h3><strong>Placa:  </strong><input type='text' readonly = 'true' id='camposemborda' name='placaAutomovel' value='$placaAutomovel' /> </h3>							
												<h3><strong>Cor:  </strong>$corAutomovel</h3>							
												<h3><strong>Direção assistida:  </strong>$direcaoAutomovel</h3>							
												<h3><strong>Ar condicionado:  </strong>$ar_condicionadoAutomovel</h3>						
												<h3><strong>Numero de porta:  </strong>$nro_de_portaAutomovel</h3>
